        ...
        CALC: {
            INNER_X: function (__this, __type) {
                ...
                for(let i = 1; i < itemList.length; i++) {
                    ...
                    const itemImgWidth = itemList[i].querySelector("img").offsetWidth;
                    value = -itemLeft + ((innerWidth - itemImgWidth) /2);
                ...
                switch(type){
                    case "2d" :
                        x = Math.round(parseInt(translate[4]));
                        y = translate[5];
                        break;
                    case "3d" :
                        x = translate[12];
                ...
                (Math.round(value) === x) ? itemList[i].classList.add("border") : itemList[i].classList.remove("border");
            },
            X: function () {
                let __vdDesignX = 0;
